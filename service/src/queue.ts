...
const pyQueue = new Queue<t.JobData, t.JobResult, Jobs.execute>(
  queueNames.python,
  { connection, prefix },
);
...
const pyQueueEvents = new QueueEvents(queueNames.python, { connection, prefix });
const otherQueueEvents = new QueueEvents(queueNames.other, { connection, prefix });
